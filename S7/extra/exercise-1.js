...
const gamesRPG = videogames.filter(game => game.genders.includes('RPG'));

const sumaTotalScore = gamesRPG.reduce((sum, game) => sum + game.score, 0);

const mediaScore = sumaTotalScore / gamesRPG.length;
