...
for (const user of users) {
    ...
    for (const sound in favoritesSounds) {
        const sounds = favoritesSounds[sound];
        //console.log(soundData);
        totalVolume += sounds.volume;
        cantidadDeSonidos++;
    }
};

const mediaVolume = totalVolume / cantidadDeSonidos;
console.log(`La media del volumen de todos los sonidos es ${mediaVolume}`);
